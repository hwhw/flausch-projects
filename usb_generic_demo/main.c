...
{   
    ...
    {   
        switch(OUTPacket[0])					//Data arrived, check what kind of command might be in the packet of data.
        {
            case 0x01:
                // read some registers
                ((UINT*)INPacket)[0] = DEVCFG0;
                ((UINT*)INPacket)[1] = DEVCFG1;
                ((UINT*)INPacket)[2] = DEVCFG2;
                ((UINT*)INPacket)[3] = PORTA;
                ((UINT*)INPacket)[4] = PORTB;
                ((UINT*)INPacket)[5] = PORTC;
		...
		// read requested register
                ((UINT*)INPacket)[0] = ((UINT*)OUTPacket)[1];
                ((UINT*)INPacket)[1] = *((UINT*)((UINT*)OUTPacket)[1]);
                if(!USBHandleBusy(USBGenericInHandle)) {	
			USBGenericInHandle = USBGenWrite(USBGEN_EP_NUM,(BYTE*)&INPacket,USBGEN_EP_SIZE);	
                }
                break;
